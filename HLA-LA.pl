...
elsif(($action eq 'call2') or ($action eq 'somatic'))
{
	...
	my $SAM_UNPROJECTED_MINIMAP2_NORMAL = $call2_processing_dir . '/remapped_and_projected.bam.minimap2.unprojected.SAM';
...
sub filterReadsAndGenerateProjectedBAM
{
	...
	my $fn_call2_minimap2_SAM = $outputBAM_thisFunction . '.minimap2.unprojected.SAM';
